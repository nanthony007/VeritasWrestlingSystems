# Generated by Django 2.1.5 on 2019-05-12 18:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gbc4', models.IntegerField(null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', django_extensions.db.fields.AutoSlugField(blank=True, editable=False, populate_from=('aabbreviation',), unique=True, verbose_name='slug')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='fs_ts',
            name='matchID',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='actions2', to='vws_main.Matchdata'),
        ),
        migrations.AddField(
            model_name='fs_match',
            name='focus',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='focus_wrestler2', to='vws_main.Wrestler'),
        ),
        migrations.AddField(
            model_name='fs_match',
            name='focus_team',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='focus_team_name2', to='vws_main.Team'),
        ),
        migrations.AddField(
            model_name='fs_match',
            name='opp_team',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='opp_team_name2', to='vws_main.Team'),
        ),
        migrations.AddField(
            model_name='fs_match',
            name='opponent',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='opp_wrestler2', to='vws_main.Wrestler'),
        ),
        migrations.AddField(
            model_name='event',
            name='matches',
